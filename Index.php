    ...
    <body>
       <div class="Contenedor">
           ...
           <header>
              ...
              <p class="cabecera_frase"> Comercializacion de productos Agriculas </p>
	        ...
	        <section class="tienda">
					...
					<figure> <center> <img src="Images/Clientes.png"> </center></figure>
					   ...
					   respectivos.</p>
				           <div></div>
	                        ...
	                        <article>
				        <figure> <center><img src="Images/Tiendas.png"></center></figure>
				          <h3>MODULO TIENDAS</h3> 
				          <p>Los propietarios de las tiendas a traves de este modulo prodran realizar
					   la consulta de productos que ofrecen los comerciantes y hacer los pedidos
				           respectivos. 
				           <br>
					  </p>
					<div></div>
				...
				<article>
					<figure> <center><img src="Images/Comerciantes.png"></center></figure>
					   ...
					   la consulta de productos que ofercen los agricultores y realizar
				           pedidos. </p>
				          <div></div>
				</article>
					...
					<figure> <center><img src="Images/Municipios.png"></center></figure>
					   ...
					   informacion. </p>
					     ...
					     <center>
						  <button type="button" class="btn_municipios" onclick="window.open('Form_municipio.php')"> INGRESAR AL MODULO
						   </button>	  
					     </center>
